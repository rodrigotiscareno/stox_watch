...
def portfolio_page():
    ...
    if st.session_state.display_recommendations:
        ...
        st.markdown(f"**Total Expected Investment:** ${high_risk_investment:,.2f}")
        st.markdown(f"**Total Expected Return:** ${high_risk_return:,.2f}")
        st.markdown(
        ...
        st.markdown(f"**Total Expected Investment:** ${medium_risk_investment:,.2f}")
        st.markdown(f"**Total Expected Return:** ${medium_risk_return:,.2f}")
        st.markdown(
        ...
        st.markdown(f"**Total Expected Investment:** ${low_risk_investment:,.2f}")
        st.markdown(f"**Total Expected Return:** ${low_risk_return:,.2f}")
        st.markdown(
