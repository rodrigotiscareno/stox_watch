...
if __name__ == "__main__":
    ...
    scheduler.add_job(recs, "cron", hour=7, minute=20)
    scheduler.add_job(top_n_stats, "cron", hour=7, minute=30)
    scheduler.add_job(insider_purchases, "cron", hour=7, minute=40)
